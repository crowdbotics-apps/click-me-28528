"""click_me_28528 URL Configuration
...
admin.site.site_header = "Click Me"
admin.site.site_title = "Click Me Admin Portal"
admin.site.index_title = "Click Me Admin"

# swagger
api_info = openapi.Info(
    title="Click Me API",
    default_version="v1",
    description="API documentation for Click Me App",
)
